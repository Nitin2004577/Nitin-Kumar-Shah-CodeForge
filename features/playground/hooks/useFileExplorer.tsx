    ...
    (set, get) => ({
      ...
      closeFile: (fileId) => {
        ...
        if (fileToClose?.hasUnsavedChanges) {
           toast.error("Please save your changes before closing this file.");
           return; 
        }
          ...
          const closeFilesInFolder = (folder: TemplateFolder, currentPath: string = "") => {
            folder.items.forEach((item) => {
              if ("filename" in item) {
                ...
                if (currentOpenFiles.find(f => f.id === fileId)) {
                    set({
                       openFiles: currentOpenFiles.filter(f => f.id !== fileId),
      ...
      updateFileContent: (fileId, content) => {
        set((state) => {
          ...
          const activeFile = updatedOpenFiles.find(f => f.id === state.activeFileId);
